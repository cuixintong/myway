...
<body>
	...
	<div class="container"
		 style="width: 98%;height:50%; background: url('${ctp}/image/remen.png');">
		<div class="row" style="margin: 0 auto">
			<div class="col-md-2"></div>
			<div class="col-md-8" style=" width: 650px; padding: 10px 100px; margin: 30px; border: 7px solid #ccc; background:white">
				<h2>用户个人信息</h2>
				<form id="myform" class="form-horizontal" action="${ctp}/rePassword" method="post" style="margin-top: 5px;">
...
<script type="text/javascript">
    ...
    function updateInfo() {
        $.post("${ctp}/updateInfo",$("#edit_info_form").serialize(),function(data){
    ...
    function updatePwd() {
        $.post("${ctp}/updatePwd",$("#edit_pwd_form").serialize(),function(data){
