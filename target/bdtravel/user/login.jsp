...
<link rel="stylesheet" href="${ctp}/css/style3.css" type="text/css" />
...
<body style="background: url('${pageContext.request.contextPath}/image/background/717.png')">
	...
	<div class="container"
		style="width: 100%; height: 460px; background:no-repeat;">
		<div class="row">
			<div class="col-md-7">
			...
			<div class="col-md-5">
				<div style="width: 440px; border: 1px solid #fcfdf7; padding: 20px 0 20px 30px; border-radius: 5px; margin-top: 60px; background:#fcfdfb ;">
					<font>用户登录</font>
