...
import com.myway.utils.PaymentUtil;
...
public class OrderController {
    ...
    public String toFillOrderPage(@RequestParam("id") Integer id, Model model){
...
//        //springmvc重定向到外网的方法
//        return  "redirect:user/paySuccess.jsp";
//
//    }
        ...
        if (isValid) {
            try {
                ...
                if (r9_BType.equals("1")) {
                    ...
                    // 浏览器重定向（展示给客户端的界面）
                    response.sendRedirect("http://localhost:8080/myway/paySuccessPage?no="+r6_Order+"&code="+order.getCode());
