...
import com.myway.utils.MD5Utils;
import com.myway.utils.MailUtils;
...
//                            + "<a href='http://localhost:8080/myway/active?activeCode=" + activeCode + "'>"
//                            + "http://localhost:8080/myway/active?activeCode=" + activeCode + "</a>";
                    String emailMsg = "恭喜您注册成功，请点击下面的连接进行激活账户"
                            + "<a href='http://cxt.vaiwan.com/myway/active?activeCode=" + activeCode + "'>"
                            + "http://cxt.vaiwan.com/myway/active?activeCode=" + activeCode + "</a>";
                    try {
    ...
    String updateState1(String id){
        userService.updateState1ById(id);
        return "OK";
    }
