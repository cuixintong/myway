...
<div class="container"
     style="width: 98%;height:50%; background: url('${ctp}/image/zhucedenglu.PNG');">
    <div class="row">
        ...
        <div class="col-md-8" style=" width: 650px; padding: 10px 100px; margin: 30px; border: 7px solid #ccc;">
            ...
            <form id="myform" class="form-horizontal" action="${ctp}/payForOrder" method="post" style="margin-top: 5px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9" style="padding-top: 5px">
                        ...
                        <img src="${ctp}/image/bank_img/icbc.bmp" style="width: 30%" align="middle" />&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="pd_FrpId" value="CCB-NET-B2C" />
                        <img src="${ctp}/image/bank_img/ccb.bmp" style="width: 30%" align="middle" />
                    </div>
                </div>
                <div class="form-group">
