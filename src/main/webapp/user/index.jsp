...
<html>
	<head>
		...
		<title>保定旅行咨询网</title>
        <%--<link rel="shortcut icon" href="../image/logo1.png" type="${ctp}/image/x-icon" />--%>
		<link rel="stylesheet" href="${ctp}/css/bootstrap.min.css" type="text/css" />
        <link href="${ctp}/css/styles.css" rel="stylesheet" type="text/css" />
        <link href="${ctp}/css/common.css" rel="stylesheet" type="text/css" />
	...
	<body>
		<div class="container-fluid">
                            ...
                            <c:forEach items="${list}" var="scenic">
                                <div class="js_con clearfix">
                                    ...
                                    <div class="js_r">
                                        ...
                                        <a href="${ctp}/getScenicTById?id=${scenic.id}" class="btn btn-default btn-info">查看门票</a>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
            ...
            <div class="container-fluid" style="margin-top:30px;">
				<img src="${ctp}/image/zmbd.PNG" width="100%"/>
			</div>
